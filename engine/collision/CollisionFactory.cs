...
namespace SimpleX.Collision2D
{
    public static class CollisionFactory
    {
        ...
        {
            var collision = new CircleCollision(position, circle);
        ...
        {
            var collision = new RectangleCollision(position, rectangle, rotation);
            collision.RefreshGeometry();
        ...
        {
            var collision = new CapsuleCollision(position, capsule, rotation);
            collision.RefreshGeometry();
        ...
        {
            var collision = new PolygonCollision(position, ref polygon, rotation);
            collision.RefreshGeometry();
        ...
        {
            var collision = new EllipseCollision(position, ellipse, rotation);
            collision.RefreshGeometry();
